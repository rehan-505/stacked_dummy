...
import 'package:stacked_dummy/ui/views/home/home_view.dart' as _i2;
...
class StackedRouter extends _i1.RouterBase {
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i3.SecondScreenView: (data) {
      return _i4.MaterialPageRoute<dynamic>(
        builder: (context) => const _i3.SecondScreenView(),
        settings: data,
        maintainState: false,
      );
    },
...
extension NavigatorStateExtension on _i5.NavigationService {
  ...
  Future<dynamic> replaceWithSecondScreenView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.secondScreenView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
